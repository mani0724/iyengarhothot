...
var Smalling = document.getElementsByClassName("small-img1");

Smalling[0].onclick = function()
{
   Productimg1.src = Smalling[0].src;
}
Smalling[1].onclick = function()
{
   Productimg1.src = Smalling[1].src;
}
Smalling[2].onclick = function()
{
   Productimg1.src = Smalling[2].src;
}
Smalling[3].onclick = function()
{
   Productimg1.src = Smalling[3].src;
}
Smalling[4].onclick = function()
{
   Productimg1.src = Smalling[4].src;
}
